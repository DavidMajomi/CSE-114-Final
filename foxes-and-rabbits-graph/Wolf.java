...
public class Wolf extends Animal
{
    ...
    // number of steps a wolf can go before it has to eat again after eating fox.
    ...
    // The fox's age.
    private int age;
    // The fox's food level, which is increased by eating rabbits and foxes.
    ...
    public Wolf(boolean randomAge, Field field, Location location)
    {
        ...
        if(randomAge) {
            ...
            // using fox food value because it is bigger
        }
        else {
            age = 0;
